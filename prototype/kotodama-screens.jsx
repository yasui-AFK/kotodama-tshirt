...
window.KT_PRODUCTS = [
  ...
  {
    id: 'tee',
    name: 'Name Calligraphy Tee',
    sub: 'Your kana, brushed in ink',
    type: 'Apparel · 100% organic cotton',
    price: 64,
    sizes: ['XS', 'S', 'M', 'L', 'XL'],
    colors: [
      { id: 'bone',  hex: '#f3ede1', label: 'Bone' },
      { id: 'ink',   hex: '#1a1814', label: 'Ink' },
      { id: 'moss',  hex: '#5a6448', label: 'Moss' },
    ],
    desc: 'Heavyweight 250gsm tee with your name brushed onto the chest in archival ink. Each one printed to order, with the kana column in traditional tategaki.',
    placeholder: 'Tee mockup',
  },
  {
    id: 'scroll',
    name: 'Hand-painted Scroll',
    sub: 'Your name on washi paper',
    type: 'Print · 30 × 90 cm',
    price: 145,
    desc: 'Sumi ink on washi paper, painted to order by a calligrapher in Kyoto. Comes with bamboo dowels and a wood box.',
    placeholder: 'Scroll',
  },
  {
    id: 'tote',
    name: 'Cotton Tote',
    sub: 'Carry your kotodama',
    type: 'Apparel · 100% cotton canvas',
    price: 32,
    sizes: ['One size'],
    colors: [
      { id: 'natural', hex: '#e7dfcb', label: 'Natural' },
      { id: 'sumi',    hex: '#1a1814', label: 'Sumi' },
    ],
    desc: 'A simple canvas tote with your name brushed on the side. Becomes more beautiful with use.',
    placeholder: 'Tote mockup',
  },
];
