...
function HeroParticleCanvas() {
  ...
  useEffectK(() => {
    ...
    resize();
    // Hero particle blobs — PINK pivot (test).
    // Revert this commit (or restore the orange palette below) to return to
    // the original peach/orange tones.
    //
    // Original ORANGE palette (kept inline for easy manual revert):
    //   [255, 175, 110]  peach
    //   [255, 210, 130]  champagne
    //   [255, 195, 165]  peach light
    //   [255, 235, 215]  cream
    //   [255, 180,  95]  amber
    //   [255, 215, 140]  honey
    ...
    //   [255, 240, 220]  ivory
    //   [255, 195, 130]  apricot
    //   [255, 220, 150]  light amber
    //   [255, 185, 110]  peach
    const blobs = [
      { c: [255, 140, 175], cx: 0.15, cy: 0.18, r: 0.22, px: 0.0, py: 1.5, sx: 0.00028, sy: 0.00038 },
      { c: [255, 170, 200], cx: 0.78, cy: 0.16, r: 0.20, px: 1.2, py: 0.5, sx: 0.00040, sy: 0.00029 },
      { c: [255, 155, 185], cx: 0.48, cy: 0.28, r: 0.18, px: 2.1, py: 2.4, sx: 0.00033, sy: 0.00045 },
      { c: [255, 200, 215], cx: 0.30, cy: 0.42, r: 0.16, px: 3.0, py: 1.0, sx: 0.00048, sy: 0.00034 },
      { c: [255, 130, 170], cx: 0.62, cy: 0.40, r: 0.20, px: 0.8, py: 2.8, sx: 0.00037, sy: 0.00042 },
      { c: [255, 165, 195], cx: 0.85, cy: 0.50, r: 0.18, px: 1.7, py: 0.2, sx: 0.00031, sy: 0.00036 },
      { c: [255, 150, 180], cx: 0.10, cy: 0.55, r: 0.20, px: 2.4, py: 1.8, sx: 0.00042, sy: 0.00031 },
      { c: [255, 135, 175], cx: 0.45, cy: 0.65, r: 0.22, px: 0.5, py: 2.1, sx: 0.00029, sy: 0.00044 },
      { c: [255, 210, 220], cx: 0.72, cy: 0.72, r: 0.16, px: 1.9, py: 0.8, sx: 0.00046, sy: 0.00027 },
      { c: [255, 145, 180], cx: 0.20, cy: 0.85, r: 0.18, px: 2.7, py: 2.3, sx: 0.00035, sy: 0.00040 },
      { c: [255, 175, 200], cx: 0.55, cy: 0.90, r: 0.20, px: 0.3, py: 1.2, sx: 0.00038, sy: 0.00033 },
      { c: [255, 140, 170], cx: 0.90, cy: 0.85, r: 0.18, px: 1.4, py: 2.6, sx: 0.00041, sy: 0.00037 },
    ];
    function draw(t) {
      ...
      <section style={{ position: 'relative', minHeight: '100vh', overflow: 'hidden', background: '#fff5e8' }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <p style={{ margin: 0, opacity: 0, fontSize: 'clamp(26px, 6.5vw, 42px)', lineHeight: 1.3, animation: 'kt-fade-up-soft 1.6s cubic-bezier(0.25,0.1,0.25,1) 14.5s forwards' }}>
              Japan has a word for this: <span style={{ color: theme.accent }}>kotodama</span>.
            </p>
            <p style={{ margin: 0, marginBottom: '1.6em', opacity: 0, fontSize: 'clamp(26px, 6.5vw, 42px)', lineHeight: 1.3, animation: 'kt-fade-up-soft 1.6s cubic-bezier(0.25,0.1,0.25,1) 14.9s forwards' }}>
